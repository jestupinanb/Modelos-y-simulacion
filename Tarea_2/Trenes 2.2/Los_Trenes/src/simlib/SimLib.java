...
public class SimLib {
    ...
    public static void timing(){
        ...
        simTren = events.element().getTren();
        events.remove();
    }
     ...
     */
    public static void eventSchedule(double time, byte type, Tren tren) {
        events.offer(new Event(type, time, tren));
    }
    
    public static void eventSchedule(double time, byte type) {
        events.offer(new Event(type, time));
    }
